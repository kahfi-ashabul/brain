      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 py-10">
        <div className="grid gap-8 md:grid-cols-3">
          <div>
            <div className="flex items-center gap-2 mb-3">
              ...
              <span className="font-bold text-slate-800 dark:text-white">BrainFlex</span>
            </div>
            <p className="text-sm text-slate-500 dark:text-slate-400 leading-relaxed">
              Sharpen your mind with science-inspired cognitive tests. Train your reaction time, mental math speed,
              working memory, and typing accuracy — all in one place.
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              <li><button onClick={() => onOpenInfo('about')} className="text-slate-500 dark:text-slate-400 hover:text-sky-500 transition">About BrainFlex</button></li>
          ...
          <div>
            ...
            <p className="text-sm text-slate-500 dark:text-slate-400 leading-relaxed">
              ...
              can improve focus, processing speed, and working memory over time. BrainFlex brings these exercises together
              in a clean, fast, ad-supported free platform.
            </p>
          </div>
        </div>
        ...
        <div className="mt-8 pt-6 border-t border-slate-200 dark:border-slate-800 flex flex-col sm:flex-row items-center justify-between gap-4">
          <p className="text-xs text-slate-400 dark:text-slate-500">
            © {new Date().getFullYear()} BrainFlex. All rights reserved.
          </p>
